...
# where the total population is split intoa grid of 9 equally sized sub populations.
...
N_patch <- 9 #number of subpopulations
...
external_I1[1] <- (sum(I[1:N_age,2])/sum(N[1:N_age,2])) + (sum(I[1:N_age,4])/sum(N[1:N_age,4]))
external_I1[2] <- (sum(I[1:N_age,1])/sum(N[1:N_age,1])) + (sum(I[1:N_age,3])/sum(N[1:N_age,3])) + (sum(I[1:N_age,5])/sum(N[1:N_age,5]))
external_I1[3] <- (sum(I[1:N_age,2])/sum(N[1:N_age,2])) + (sum(I[1:N_age,6])/sum(N[1:N_age,6]))
external_I1[4] <- (sum(I[1:N_age,1])/sum(N[1:N_age,1])) + (sum(I[1:N_age,5])/sum(N[1:N_age,5])) + (sum(I[1:N_age,7])/sum(N[1:N_age,7]))
external_I1[5] <- (sum(I[1:N_age,2])/sum(N[1:N_age,2])) + (sum(I[1:N_age,4])/sum(N[1:N_age,4])) + (sum(I[1:N_age,6])/sum(N[1:N_age,6])) + (sum(I[1:N_age,8])/sum(N[1:N_age,8]))
external_I1[6] <- (sum(I[1:N_age,3])/sum(N[1:N_age,3])) + (sum(I[1:N_age,5])/sum(N[1:N_age,5])) + (sum(I[1:N_age,9])/sum(N[1:N_age,9]))
external_I1[7] <- (sum(I[1:N_age,4])/sum(N[1:N_age,4])) + (sum(I[1:N_age,8])/sum(N[1:N_age,8]))
external_I1[8] <- (sum(I[1:N_age,5])/sum(N[1:N_age,5])) + (sum(I[1:N_age,7])/sum(N[1:N_age,7])) + (sum(I[1:N_age,9])/sum(N[1:N_age,9]))
external_I1[9] <- (sum(I[1:N_age,6])/sum(N[1:N_age,6])) + (sum(I[1:N_age,8])/sum(N[1:N_age,8]))

## FOI from second-plus-time infections in other patches
external_I2[1] <- (sum(I2[1:N_age,2])/sum(N[1:N_age,2])) + (sum(I2[1:N_age,4])/sum(N[1:N_age,4]))
external_I2[2] <- (sum(I2[1:N_age,1])/sum(N[1:N_age,1])) + (sum(I2[1:N_age,3])/sum(N[1:N_age,3])) + (sum(I2[1:N_age,5])/sum(N[1:N_age,5]))
external_I2[3] <- (sum(I2[1:N_age,2])/sum(N[1:N_age,2])) + (sum(I2[1:N_age,6])/sum(N[1:N_age,6]))
external_I2[4] <- (sum(I2[1:N_age,1])/sum(N[1:N_age,1])) + (sum(I2[1:N_age,5])/sum(N[1:N_age,5])) + (sum(I2[1:N_age,7])/sum(N[1:N_age,7]))
external_I2[5] <- (sum(I2[1:N_age,2])/sum(N[1:N_age,2])) + (sum(I2[1:N_age,4])/sum(N[1:N_age,4])) + (sum(I2[1:N_age,6])/sum(N[1:N_age,6])) + (sum(I2[1:N_age,8])/sum(N[1:N_age,8]))
external_I2[6] <- (sum(I2[1:N_age,3])/sum(N[1:N_age,3])) + (sum(I2[1:N_age,5])/sum(N[1:N_age,5])) + (sum(I2[1:N_age,9])/sum(N[1:N_age,9]))
external_I2[7] <- (sum(I2[1:N_age,4])/sum(N[1:N_age,4])) + (sum(I2[1:N_age,8])/sum(N[1:N_age,8]))
external_I2[8] <- (sum(I2[1:N_age,5])/sum(N[1:N_age,5])) + (sum(I2[1:N_age,7])/sum(N[1:N_age,7])) + (sum(I2[1:N_age,9])/sum(N[1:N_age,9]))
external_I2[9] <- (sum(I2[1:N_age,6])/sum(N[1:N_age,6])) + (sum(I2[1:N_age,8])/sum(N[1:N_age,8]))
...
new_I[25, 5] <- I[i,j] - outflow_I[i,j] + new_infections[i,j] + new_infections_mAb[i,j] + imported_cases
new_I[25, 1:4] <- I[i,j] - outflow_I[i,j] + new_infections[i,j] + new_infections_mAb[i,j]
new_I[25, 6:N_patch] <- I[i,j] - outflow_I[i,j] + new_infections[i,j] + new_infections_mAb[i,j]
